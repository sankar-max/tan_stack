        ...
        <article className="flex flex-col h-full bg-card rounded-2xl border border-border/40 hover:border-primary/20 transition-all duration-300 hover:shadow-lg overflow-hidden relative">
          ...
          <div className="p-7 flex flex-col flex-1 relative z-10">
            ...
            <div className="flex items-center gap-4 mt-auto relative z-20">
              ...
              >
                ...
                <span
                  ...
                  onClick={(e) => {
                    ...
                    openModal("LIKE_VIEW", {
                      title: "Likes",
                      description: "People who liked this story",
              ...
              <button
                className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground hover:text-primary transition-all duration-300 hover:scale-110"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  openModal("COMMENT_VIEW", {
                    title: "Comments",
                    description: "Recent discussion",
                    props: { postId: post.id },
                  });
                }}
              >
